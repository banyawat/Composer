...
/**
 * Chords and scale transpose would be stored in this opponent
 */
public class ComposerRightHand {
    private int id;
    private String title;
    private ArrayList<Integer> key = new ArrayList<>();
    private ArrayList<Integer> minor = new ArrayList<>();

    public ComposerRightHand(int id, String title, String keyAndMinor){
        this.id = id;
        this.title = title;
        try {
    ...
    public ComposerRightHand(int id, String title, int key, int minor){
        this.id = id;
        this.title = title;
        this.key.add(key);
