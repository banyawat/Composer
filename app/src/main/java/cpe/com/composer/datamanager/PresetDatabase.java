...
public class PresetDatabase extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase preDb) {
        ...
        preDb.execSQL("INSERT INTO " + TABLE_NAME + " VALUES(null, 'Groove Drum', 9, -1, '{\"note\":[53,53,53,53,36,36,38,36,36,36,38,38,38],\"ppq\":[0,4,8,12,0,3,4,6,10,11,12,14,15]}\n', 0);");
        preDb.execSQL("INSERT INTO " + TABLE_NAME + " VALUES(null, 'Kick', 9, -1, '{\"note\":[36,36,36,36,0],\"ppq\":[0,4,8,12,15]}\n', 0);");
        preDb.execSQL("INSERT INTO " + TABLE_NAME + " VALUES(null, 'Electric Bass', 1, " + ProgramChange.MidiProgram.ELECTRIC_BASS_PICK.programNumber() + ", " +
                "'{\"note\":[39,42,44,45,51,45,44,51,39,39,39,39],\"ppq\":[0,1,2,4,5,6,7,10,11,12,13,14]}\n', 0);");
        preDb.execSQL("INSERT INTO " + TABLE_NAME + " VALUES(null, 'Electirc Guitar', 2, " + ProgramChange.MidiProgram.ELECTRIC_GUITAR_CLEAN.programNumber() + ", '{\"note\":[63,66,70,63,66,70,63,66,70,72,63,66,70,72]," +
                "\"ppq\":[0,0,0,3,3,3,6,6,6,6,9,9,9,9],\"dur\":[220,220,220,50,50,50,220,220,220,220,50,50,50,50]}\n', 0);");
        preDb.execSQL("INSERT INTO " + TABLE_NAME + " VALUES(null, 'C', 0, 0, 2, 1);");
        preDb.execSQL("INSERT INTO " + TABLE_NAME + " VALUES(null, 'D', 0, 0, 5, 1);");
    }
